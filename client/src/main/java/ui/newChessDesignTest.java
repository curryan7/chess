...
import static ui.EscapeSequences.*;
    ...
    public class newChessDesignTest {
        ...
        private static void setSquareColors(PrintStream out, int orientation, boolean isEvenSquare) {
            if (isEvenSquare) {
                out.print(orientation == 1 ? SET_BG_COLOR_WHITE : SET_BG_COLOR_BLACK);
                out.print(SET_TEXT_COLOR_GREEN);
            } else {
                out.print(orientation == 1 ? SET_BG_COLOR_BLACK : SET_BG_COLOR_WHITE);
